        ...
        <div className="px-2">
            <div className="py-4 border-b border-b-gray-800 flex justify-between items-center max-w-6xl m-auto">
                <h2 className="text-md text-white font-semibold">
                    <a href="#" className="hover:text-sky-500">Ahsanul Hoque Famid</a>
                </h2>
                <ul className="flex justify-center items-center gap-3">
                    <li className="text-white text-sm" title="GitHub">
                        <a href="https://github.com/famid" target="_blank" rel="noopener noreferrer" className="ease-in-out duration-150 hover:text-sky-500">
                            <FaGithub />
                        </a>
                    </li>
                    <li className="text-white text-sm" title="LinkedIn">
                        <a href="https://www.linkedin.com/in/ahsanul-hoque-famid/" target="_blank" rel="noopener noreferrer" className="ease-in-out duration-150 hover:text-sky-500">
                            <FaLinkedinIn />
                        </a>
                    </li>
                </ul>
            ...
            <div className="py-8 flex flex-col gap-4 justify-between items-center max-w-6xl m-auto sm:flex-row sm:gap-0">
                <ul className="flex justify-center items-center gap-4">
                    ...
                    <li className="text-gray-400 text-sm" title="Blog">
                ...
                <h5 className="text-white font-initial text-sm">&copy; 2025 - Ahsanul Hoque Famid. All Rights Reserved.</h5>
            </div>
            <div className="py-8 pt-0 px-2">
                <h5 className="text-white text-sm text-center leading-6">
                    ...
                    Open Sourced on {" "}
                    <a href="https://github.com/famid/my-portfolio"
